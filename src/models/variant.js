import { variant_list as queryvariants, deleteByUuid } from '@/services/variant';
...
export default {
  ...
  effects: {
    *getAllvariant({payload}, { call, put }) {
      try {
        const response = yield call(queryvariants,payload);
        yield put({
          type: 'getAllvariantData',
  ...
  reducers: {
    getAllvariantData(state, action) {
